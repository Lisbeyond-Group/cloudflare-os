    ...
    <div className="relative isolate hidden h-[176px] w-[444px] lg:block">
      ...
      <div className="group absolute left-[176px] top-[58px] z-20">
        <button
          ...
          aria-label="Permissions keep Lisbeyond OS limited to connected resources"
        >
          ...
          <div className="flex items-start gap-2.5">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-[11px] leading-4 font-normal tracking-[-0.1px] text-kumo-subtle">
                Keeps Bifana and workflows limited to connected resources and verifies each employee's permissions before data is returned.
              </p>
            </div>
          </div>
        ...
        <header className="mb-8 grid gap-8 lg:grid-cols-[minmax(0,540px)_444px] lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-2 text-[14px] leading-[20px] font-normal tracking-[-0.25px] text-kumo-subtle">
              See which systems and accounts Lisbeyond OS can use. Every request is still checked
              against the signed-in employee's permissions.
            </p>
          </div>
            ...
            <EmptyState
              ...
              description={
                search
                  ...
                  : 'Connections will appear here as they become available to your Lisbeyond account.'
              }
              icon={Plugs}
            />
          )}
