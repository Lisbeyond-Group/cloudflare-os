...
export default function SidebarItem({
  ...
  return (
    <Link
      ...
      className={[
        'group relative flex h-8 items-center gap-2.5 rounded-lg px-2.5 text-[13px] leading-[18px] tracking-[-0.25px] transition-colors xl:h-9 xl:text-[14px] 2xl:h-10 2xl:text-[15px]',
        isActive
